...
public class Excercise14 {
	...
	public static void main(String[] args) {
		...
		// swap element on index 0 with element with index 2

		Collections.swap(colors, 0, 2);

		System.out.println("Colors swapped: " + colors);
		...
		// treba da napravime metod koj kje prima dva argumenti, prviot argument e
		// lista, vtoriot e bojata,
	...
	// metod sho kje presmeta kolku elementi ima lista, metodot vrakja integer a
	// prima lista
	...
	// metod sho kje ni kaze kolku parni broevi imame vo listata
	...
	//metod sho kje ni vrati objekt koj sodrzi dva parametri (paren i neparen) i kje ni kaze kolku ima parni
